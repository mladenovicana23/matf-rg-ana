    ...
    */
    ...
    public:
        ...
        */
        ...
        static void create_hdr_framebuffer(
            uint32_t width,
            uint32_t height,
        ...
        static void create_pingpong_framebuffers(
            uint32_t width,
            uint32_t height,
        ...
        static void bind_framebuffer(uint32_t framebuffer);

        static void draw_fullscreen_quad(uint32_t vao);

        static void bind_texture_2d(uint32_t texture, uint32_t unit);

        static void set_depth_test(bool enabled);

        static void destroy_bloom_resources(
            uint32_t hdr_fbo,
            uint32_t color_buffers[2],
            uint32_t depth_rbo,
